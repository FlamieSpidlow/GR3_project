      ...
      <main class="content">
        ...
        <div class="tw-container-wide">
          ...
          <div v-else-if="favoritePlaces.length === 0" class="empty-state">
            ...
            <h2>Bạn chưa lưu địa điểm nào</h2>
            <p>Lưu những nơi phù hợp với độ tuổi, sở thích và lịch cuối tuần của gia đình để xem lại nhanh.</p>
            <router-link to="/places" class="btn-primary">Khám phá địa điểm</router-link>
          </div>
          ...
          <div v-else>
            <CategoryFilter
              ...
              :total-count="favoritePlaces.length"
...
export default {
  ...
  computed: {
    filteredFavoritePlaces() {
      return filterPlacesByCategoryOptions(this.favoritePlaces, this.activeCategory, this.categoryOptions)
    },
    categoryOptions() {
