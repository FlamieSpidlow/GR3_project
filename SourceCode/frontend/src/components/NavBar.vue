          ...
          <template v-if="isAuthenticated">
            <div class="user-info">
              <div class="user-details">
                ...
                <p class="email">{{ formatEmail(user.email) }}</p>
              </div>
            </div>
            <div class="user-menu">
      ...
      <div class="search-dialog" role="dialog" aria-modal="true">
        ...
        <div class="search-body">
          ...
          <div class="search-age">
            <label>Độ tuổi của bé: <strong>{{ searchAge }} tuổi</strong></label>
...
import { formatEmail } from '../utils/infoFormatter'
...
export default {
  ...
  methods: {
    ...
    notificationTypeLabel(type) {
      if (type === 'place') return 'Gợi ý địa điểm'
      if (type === 'review') return 'Đánh giá'
      if (type === 'ticket') return 'Lịch đi sắp tới'
...
.notification-item.place { border-left: 4px solid #4f6f8f; }
.notification-item.review { border-left: 4px solid #7c3aed; }
.notification-item.ticket { border-left: 4px solid #0891b2; }
