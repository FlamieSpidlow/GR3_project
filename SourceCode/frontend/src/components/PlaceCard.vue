    ...
    <div class="card-body">
      ...
      <div class="meta-row">
        <span v-if="getRating(place) > 0" class="rating-meta">
          <StarIcon class="meta-icon rating-star" aria-hidden="true" />
          <span>{{ getRating(place) }}/5</span>
        </span>
        <span v-else class="no-rating">Chưa có đánh giá</span>
        <span class="age-meta"><UserGroupIcon class="meta-icon" aria-hidden="true" /> {{ place.ageRange || '0-12' }} tuổi</span>
...
import { StarIcon, UserGroupIcon } from '@heroicons/vue/24/outline'
