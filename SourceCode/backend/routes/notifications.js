...
router.get('/', async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, error: 'Không thể tải thông báo', details: err.message })
  }
})
...
router.post('/', async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, error: 'Không thể tạo thông báo', details: err.message })
  }
})
...
router.patch('/read', async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, error: 'Không thể cập nhật thông báo', details: err.message })
  }
})
...
router.delete('/', async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, error: 'Không thể xóa thông báo', details: err.message })
  }
})
