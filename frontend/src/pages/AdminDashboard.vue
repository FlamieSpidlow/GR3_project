...
.ops-row > div strong { display:block; color:#0f172a; }
.ops-row > div span { display:block; margin-top:3px; color:#64748b; font-size:.84rem; }
/* Badge trạng thái không co lại trong hàng flex (bề rộng chuẩn ở StatusBadge.vue) */
.ops-row :deep(.status-badge) { flex:none; }
